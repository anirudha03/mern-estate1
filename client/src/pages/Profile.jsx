...
import {
  ...
  signOutSuccess,
  signOutStart,
} from "../redux/user/userSlice"; //always add use dispatch
...
export default function Profile() {
  ...
  const handleListingDelete = async (listingId) => {
    try {
      ...
      //update the listings in show listings after the deletion is done 
  ...
  const handleSubmit = async (e) => {
    e.preventDefault(); // prevents rrefreshing the page
    try {
